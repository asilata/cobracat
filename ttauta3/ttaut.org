...
* The graph  
  #+begin_src dot :file ttauta3.svg :exports results
	digraph ttauta3 {
		...
		#----------------------------------------------------------------------------------------------------
		"abcx-aaxc" -> "abcx-abxc" [taillabel="ta", label="b>a-b+x", labeltooltip="a:b; b:x+c; c:c; x:a-b+x",url=""];
		"bcdy-dbby" -> "bcdy-dbcy" [taillabel="tb", label="c>b-c+y", labeltooltip="b:c; c:y+d; d:d; y:b-c+y",url=""];
		"acdx-xacc" -> "acdx-xacd" [taillabel="tc", label="d>c-d+x", labeltooltip="c:d; d:x+a; a:a; x:c-d+x",url=""];
		"abdy-dybd" -> "abdy-aybd" [taillabel="td", label="a>d-a+y", labeltooltip="d:a; a:y+b; b:b; y:d-a+y",url=""];
		"abcy-aycc" -> "abcy-aybc" [taillabel="sc", label="b>c-b+y", labeltooltip="c:b; b:y+a; a:a; y:c-b+y",url=""];
		"abdx-xbbd" -> "abdx-xabd" [taillabel="sb", label="a>b-a+x", labeltooltip="b:a; a:x+d; d:d; x:b-a+x",url=""];
		"acdy-aacy" -> "acdy-dacy" [taillabel="sa", label="d>a-d+y", labeltooltip="a:d; d:y+c; c:c; y:a-d+y",url=""];
		"bcdx-dbxd" -> "bcdx-dbxc" [taillabel="sd", label="c>d-c+x", labeltooltip="d:c; c:x+b; b:b; x:d-c+x",url=""];
		#----------------------------------------------------------------------------------------------------
		"abcx-aaxc" -> "abcx-xbxc" [taillabel="ta", label="b>a-b+x", labeltooltip="a:b; b:x+c; c:c; x:a-b+x",url=""];
		"bcdy-dbby" -> "bcdy-dycy" [taillabel="tb", label="c>b-c+y", labeltooltip="b:c; c:y+d; d:d; y:b-c+y",url=""];
		"acdx-xacc" -> "acdx-xaxd" [taillabel="tc", label="d>c-d+x", labeltooltip="c:d; d:x+a; a:a; x:c-d+x",url=""];
		"abdy-dybd" -> "abdy-ayby" [taillabel="td", label="a>d-a+y", labeltooltip="d:a; a:y+b; b:b; y:d-a+y",url=""];
		"abcy-aycc" -> "abcy-ayby" [taillabel="sc", label="b>c-b+y", labeltooltip="c:b; b:y+a; a:a; y:c-b+y",url=""];
		"abdx-xbbd" -> "abdx-xaxd" [taillabel="sb", label="a>b-a+x", labeltooltip="b:a; a:x+d; d:d; x:b-a+x",url=""];
		"acdy-aacy" -> "acdy-dycy" [taillabel="sa", label="d>a-d+y", labeltooltip="a:d; d:y+c; c:c; y:a-d+y",url=""];
		"bcdx-dbxd" -> "bcdx-xbxc" [taillabel="sd", label="c>d-c+x", labeltooltip="d:c; c:x+b; b:b; x:d-c+x",url=""];
		#----------------------------------------------------------------------------------------------------
