...
#+PROPERTY: header-args:sage :tangle artifacts/ttauta3.sage :mkdirp yes
...
* The sage function
We write sage functions that apply a given twist to a given element on the sphere of sphericals.

We recall the notation.
We assume that our stability condition is given by the following configuration:
#+begin_export ascii
2-----3
|     |
|     |
...
The twist is specified by one of the eight strings: sa, sb, sc, sd, ta, tb, tc, td.
We encode the Harder-Narasimhan multiplicities by a dictionary
{ a:- , b:-, c:-, d:-, x:-, y:-}

The raw information of the automaton is contained in the following dictionary. 
#+begin_src sage
  hnvars = var('a','b','c','d','x','y')
  automaton = {
...
The following function applies a given spherical twist on a given HN multiplicity vector.
#+begin_src sage
  def PLTwist(twist, vector):
      support = {str(s) for s in vector.keys() if vector[s] != 0}
      # The support may not be full.
      # We find a full support that contains the given support.
      fullSupport = None
      for k in automaton.keys():
          if support.issubset(set(k)):
              fullSupport = k
              break
  
      if fullSupport == None:
          raise Exception("The support of the given element is too big.")
  
      plData = [(d[1],d[2]) for d in automaton[fullSupport] if d[0] == twist]
  
      # We set the missing variables as 0.
      for v in hnvars:
          if v not in vector.keys():
              vector[v] = 0
              
      # We now apply according to the conditions that are satisfied.
      for (conditions, substitutions) in plData:
          if all([condition.substitute(vector) for condition in conditions]):
              return {v: substitutions[v].substitute(vector) for v in substitutions.keys()}
  
     # No conditions matched
      raise Exception("No applicable function found.")
#+end_src
...
Tests
#+begin_src sage
  PLTwist("ta",PLTwist("sa",PLTwist("tb",PLTwist("sa", {b:1}))))
#+end_src

Composition
#+begin_src sage
  def composeTwists(lst):
      def composition(v):
          out = v
  ...
  beta = composeTwists(["sa","sb","tc","sd"])
#+end_src
...
:EXPORT_FILE_NAME: curves.tex
:END:

Visualising.
#+begin_src sage :exports none
  templateBegin = """\\begin{tikzpicture}
  \\draw (0,0) node [circle, draw] (1) {};
  \\draw (0,1) node [circle, draw] (2) {};
  \\draw (1,1) node [circle, draw] (3) {};
  \\draw (1,0) node [circle, draw] (4) {};
  """
  templateEnd= "\\end{tikzpicture}"
  def drawCurve(crv):
      print(templateBegin)
      for k in crv.keys():
          line = ""
          if crv[k] != 0:
              if k == a:
                  line="\\draw (1) edge node[left] {\\tiny "+str(crv[k])+"} (2);"
              elif k == b:
                  line="\\draw (2) edge node[above] {\\tiny "+str(crv[k])+"} (3);"
              elif k == c:
                  line="\\draw (3) edge node[right] {\\tiny "+str(crv[k])+"} (4);"
              elif k == d:
                  line="\\draw (4) edge node[below] {\\tiny "+str(crv[k])+"} (1);"
              elif k == x:
                  line="\\draw (1) edge node[left] {\\tiny "+str(crv[k])+"} (3);"
              elif k == y:
                  line="\\draw (2) edge node[right] {\\tiny "+str(crv[k])+"} (4);"
          print(line)
      print(templateEnd)
#+end_src

#+begin_src sage :results code latex :exports results
  c = {a:1}
...
\draw (4) edge node[below] {\tiny 2} (1);


\draw (1) edge node[left] {\tiny 1} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 3} (1);
\draw (1) edge node[left] {\tiny 2} (2);
...
\draw (4) edge node[below] {\tiny 2} (1);
\draw (1) edge node[left] {\tiny 1} (2);
\draw (2) edge node[above] {\tiny 2} (3);
...
\draw (4) edge node[below] {\tiny 4} (1);
\draw (1) edge node[left] {\tiny 1} (2);
\draw (2) edge node[above] {\tiny 1} (3);
\draw (1) edge node[left] {\tiny 2} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 5} (1);
\draw (1) edge node[left] {\tiny 3} (2);
\draw (2) edge node[above] {\tiny 1} (3);
\draw (1) edge node[left] {\tiny 1} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 4} (1);
\draw (1) edge node[left] {\tiny 2} (2);
\draw (2) edge node[above] {\tiny 3} (3);
\draw (1) edge node[left] {\tiny 1} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 6} (1);
\draw (1) edge node[left] {\tiny 2} (2);
\draw (2) edge node[above] {\tiny 2} (3);
\draw (1) edge node[left] {\tiny 3} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 7} (1);
\draw (1) edge node[left] {\tiny 4} (2);
\draw (2) edge node[above] {\tiny 2} (3);
\draw (1) edge node[left] {\tiny 2} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 6} (1);
\draw (1) edge node[left] {\tiny 3} (2);
\draw (2) edge node[above] {\tiny 4} (3);
\draw (1) edge node[left] {\tiny 2} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 8} (1);
\draw (1) edge node[left] {\tiny 3} (2);
\draw (2) edge node[above] {\tiny 3} (3);
\draw (1) edge node[left] {\tiny 4} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 9} (1);
\draw (1) edge node[left] {\tiny 5} (2);
\draw (2) edge node[above] {\tiny 3} (3);
\draw (1) edge node[left] {\tiny 3} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 8} (1);
\draw (1) edge node[left] {\tiny 4} (2);
\draw (2) edge node[above] {\tiny 5} (3);
\draw (1) edge node[left] {\tiny 3} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 10} (1);
\draw (1) edge node[left] {\tiny 4} (2);
\draw (2) edge node[above] {\tiny 4} (3);
\draw (1) edge node[left] {\tiny 5} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 11} (1);
\draw (1) edge node[left] {\tiny 6} (2);
\draw (2) edge node[above] {\tiny 4} (3);
\draw (1) edge node[left] {\tiny 4} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 10} (1);
\draw (1) edge node[left] {\tiny 5} (2);
\draw (2) edge node[above] {\tiny 6} (3);
\draw (1) edge node[left] {\tiny 4} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 12} (1);
\draw (1) edge node[left] {\tiny 5} (2);
\draw (2) edge node[above] {\tiny 5} (3);
\draw (1) edge node[left] {\tiny 6} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 13} (1);
\draw (1) edge node[left] {\tiny 7} (2);
\draw (2) edge node[above] {\tiny 5} (3);
\draw (1) edge node[left] {\tiny 5} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 12} (1);
\draw (1) edge node[left] {\tiny 6} (2);
\draw (2) edge node[above] {\tiny 7} (3);
\draw (1) edge node[left] {\tiny 5} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 14} (1);
\draw (1) edge node[left] {\tiny 6} (2);
\draw (2) edge node[above] {\tiny 6} (3);
\draw (1) edge node[left] {\tiny 7} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 15} (1);
\draw (1) edge node[left] {\tiny 8} (2);
\draw (2) edge node[above] {\tiny 6} (3);
\draw (1) edge node[left] {\tiny 6} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 14} (1);
\draw (1) edge node[left] {\tiny 7} (2);
\draw (2) edge node[above] {\tiny 8} (3);
\draw (1) edge node[left] {\tiny 6} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 16} (1);
\draw (1) edge node[left] {\tiny 7} (2);
\draw (2) edge node[above] {\tiny 7} (3);
\draw (1) edge node[left] {\tiny 8} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 17} (1);
\draw (1) edge node[left] {\tiny 9} (2);
\draw (2) edge node[above] {\tiny 7} (3);
\draw (1) edge node[left] {\tiny 7} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 16} (1);
\draw (1) edge node[left] {\tiny 8} (2);
\draw (2) edge node[above] {\tiny 9} (3);
\draw (1) edge node[left] {\tiny 7} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 18} (1);
\draw (1) edge node[left] {\tiny 8} (2);
\draw (2) edge node[above] {\tiny 8} (3);
\draw (1) edge node[left] {\tiny 9} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 19} (1);
\draw (1) edge node[left] {\tiny 10} (2);
\draw (2) edge node[above] {\tiny 8} (3);
\draw (1) edge node[left] {\tiny 8} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 18} (1);
\draw (1) edge node[left] {\tiny 9} (2);
\draw (2) edge node[above] {\tiny 10} (3);
\draw (1) edge node[left] {\tiny 8} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 20} (1);
\draw (1) edge node[left] {\tiny 9} (2);
\draw (2) edge node[above] {\tiny 9} (3);
\draw (1) edge node[left] {\tiny 10} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 21} (1);
\draw (1) edge node[left] {\tiny 11} (2);
\draw (2) edge node[above] {\tiny 9} (3);
\draw (1) edge node[left] {\tiny 9} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 20} (1);
\draw (1) edge node[left] {\tiny 10} (2);
\draw (2) edge node[above] {\tiny 11} (3);
\draw (1) edge node[left] {\tiny 9} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 22} (1);
\draw (1) edge node[left] {\tiny 10} (2);
\draw (2) edge node[above] {\tiny 10} (3);
\draw (1) edge node[left] {\tiny 11} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 23} (1);
\draw (1) edge node[left] {\tiny 12} (2);
\draw (2) edge node[above] {\tiny 10} (3);
\draw (1) edge node[left] {\tiny 10} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 22} (1);
\draw (1) edge node[left] {\tiny 11} (2);
\draw (2) edge node[above] {\tiny 12} (3);
\draw (1) edge node[left] {\tiny 10} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 24} (1);
\draw (1) edge node[left] {\tiny 11} (2);
\draw (2) edge node[above] {\tiny 11} (3);
\draw (1) edge node[left] {\tiny 12} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 25} (1);
\draw (1) edge node[left] {\tiny 13} (2);
\draw (2) edge node[above] {\tiny 11} (3);
\draw (1) edge node[left] {\tiny 11} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 24} (1);
\draw (1) edge node[left] {\tiny 12} (2);
\draw (2) edge node[above] {\tiny 13} (3);
\draw (1) edge node[left] {\tiny 11} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 26} (1);
\draw (1) edge node[left] {\tiny 12} (2);
\draw (2) edge node[above] {\tiny 12} (3);
\draw (1) edge node[left] {\tiny 13} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 27} (1);
\draw (1) edge node[left] {\tiny 14} (2);
\draw (2) edge node[above] {\tiny 12} (3);
\draw (1) edge node[left] {\tiny 12} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 26} (1);
\draw (1) edge node[left] {\tiny 13} (2);
\draw (2) edge node[above] {\tiny 14} (3);
\draw (1) edge node[left] {\tiny 12} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 28} (1);
\draw (1) edge node[left] {\tiny 13} (2);
\draw (2) edge node[above] {\tiny 13} (3);
\draw (1) edge node[left] {\tiny 14} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 29} (1);
\draw (1) edge node[left] {\tiny 15} (2);
\draw (2) edge node[above] {\tiny 13} (3);
\draw (1) edge node[left] {\tiny 13} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 28} (1);
\draw (1) edge node[left] {\tiny 14} (2);
\draw (2) edge node[above] {\tiny 15} (3);
\draw (1) edge node[left] {\tiny 13} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 30} (1);
\draw (1) edge node[left] {\tiny 14} (2);
\draw (2) edge node[above] {\tiny 14} (3);
\draw (1) edge node[left] {\tiny 15} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 31} (1);
\draw (1) edge node[left] {\tiny 16} (2);
\draw (2) edge node[above] {\tiny 14} (3);
\draw (1) edge node[left] {\tiny 14} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 30} (1);
\draw (1) edge node[left] {\tiny 15} (2);
\draw (2) edge node[above] {\tiny 16} (3);
\draw (1) edge node[left] {\tiny 14} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 32} (1);
\draw (1) edge node[left] {\tiny 15} (2);
\draw (2) edge node[above] {\tiny 15} (3);
\draw (1) edge node[left] {\tiny 16} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 33} (1);
\draw (1) edge node[left] {\tiny 17} (2);
\draw (2) edge node[above] {\tiny 15} (3);
\draw (1) edge node[left] {\tiny 15} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 32} (1);
\draw (1) edge node[left] {\tiny 16} (2);
\draw (2) edge node[above] {\tiny 17} (3);
\draw (1) edge node[left] {\tiny 15} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 34} (1);
\draw (1) edge node[left] {\tiny 16} (2);
\draw (2) edge node[above] {\tiny 16} (3);
\draw (1) edge node[left] {\tiny 17} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 35} (1);
\draw (1) edge node[left] {\tiny 18} (2);
\draw (2) edge node[above] {\tiny 16} (3);
\draw (1) edge node[left] {\tiny 16} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 34} (1);
\draw (1) edge node[left] {\tiny 17} (2);
\draw (2) edge node[above] {\tiny 18} (3);
\draw (1) edge node[left] {\tiny 16} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 36} (1);
\draw (1) edge node[left] {\tiny 17} (2);
\draw (2) edge node[above] {\tiny 17} (3);
\draw (1) edge node[left] {\tiny 18} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 37} (1);
\draw (1) edge node[left] {\tiny 19} (2);
\draw (2) edge node[above] {\tiny 17} (3);
\draw (1) edge node[left] {\tiny 17} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 36} (1);
\draw (1) edge node[left] {\tiny 18} (2);
\draw (2) edge node[above] {\tiny 19} (3);
\draw (1) edge node[left] {\tiny 17} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 38} (1);
\draw (1) edge node[left] {\tiny 18} (2);
\draw (2) edge node[above] {\tiny 18} (3);
\draw (1) edge node[left] {\tiny 19} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 39} (1);
\draw (1) edge node[left] {\tiny 20} (2);
\draw (2) edge node[above] {\tiny 18} (3);
\draw (1) edge node[left] {\tiny 18} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 38} (1);
\draw (1) edge node[left] {\tiny 19} (2);
\draw (2) edge node[above] {\tiny 20} (3);
\draw (1) edge node[left] {\tiny 18} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 40} (1);
\draw (1) edge node[left] {\tiny 19} (2);
\draw (2) edge node[above] {\tiny 19} (3);
\draw (1) edge node[left] {\tiny 20} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 41} (1);
\draw (1) edge node[left] {\tiny 21} (2);
\draw (2) edge node[above] {\tiny 19} (3);
\draw (1) edge node[left] {\tiny 19} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 40} (1);
\draw (1) edge node[left] {\tiny 20} (2);
\draw (2) edge node[above] {\tiny 21} (3);
\draw (1) edge node[left] {\tiny 19} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 42} (1);
\draw (1) edge node[left] {\tiny 20} (2);
\draw (2) edge node[above] {\tiny 20} (3);
\draw (1) edge node[left] {\tiny 21} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 43} (1);
\draw (1) edge node[left] {\tiny 22} (2);
\draw (2) edge node[above] {\tiny 20} (3);
\draw (1) edge node[left] {\tiny 20} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 42} (1);
\draw (1) edge node[left] {\tiny 21} (2);
\draw (2) edge node[above] {\tiny 22} (3);
\draw (1) edge node[left] {\tiny 20} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 44} (1);
\draw (1) edge node[left] {\tiny 21} (2);
\draw (2) edge node[above] {\tiny 21} (3);
\draw (1) edge node[left] {\tiny 22} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 45} (1);
\draw (1) edge node[left] {\tiny 23} (2);
\draw (2) edge node[above] {\tiny 21} (3);
\draw (1) edge node[left] {\tiny 21} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 44} (1);
\draw (1) edge node[left] {\tiny 22} (2);
\draw (2) edge node[above] {\tiny 23} (3);
\draw (1) edge node[left] {\tiny 21} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 46} (1);
\draw (1) edge node[left] {\tiny 22} (2);
\draw (2) edge node[above] {\tiny 22} (3);
\draw (1) edge node[left] {\tiny 23} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 47} (1);
\draw (1) edge node[left] {\tiny 24} (2);
\draw (2) edge node[above] {\tiny 22} (3);
\draw (1) edge node[left] {\tiny 22} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 46} (1);
\draw (1) edge node[left] {\tiny 23} (2);
\draw (2) edge node[above] {\tiny 24} (3);
\draw (1) edge node[left] {\tiny 22} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 48} (1);
\draw (1) edge node[left] {\tiny 23} (2);
\draw (2) edge node[above] {\tiny 23} (3);
\draw (1) edge node[left] {\tiny 24} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 49} (1);
\draw (1) edge node[left] {\tiny 25} (2);
\draw (2) edge node[above] {\tiny 23} (3);
\draw (1) edge node[left] {\tiny 23} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 48} (1);
\draw (1) edge node[left] {\tiny 24} (2);
\draw (2) edge node[above] {\tiny 25} (3);
\draw (1) edge node[left] {\tiny 23} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 50} (1);
\draw (1) edge node[left] {\tiny 24} (2);
\draw (2) edge node[above] {\tiny 24} (3);
\draw (1) edge node[left] {\tiny 25} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 51} (1);
\draw (1) edge node[left] {\tiny 26} (2);
\draw (2) edge node[above] {\tiny 24} (3);
\draw (1) edge node[left] {\tiny 24} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 50} (1);
\draw (1) edge node[left] {\tiny 25} (2);
\draw (2) edge node[above] {\tiny 26} (3);
\draw (1) edge node[left] {\tiny 24} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 52} (1);
\draw (1) edge node[left] {\tiny 25} (2);
\draw (2) edge node[above] {\tiny 25} (3);
\draw (1) edge node[left] {\tiny 26} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 53} (1);
\draw (1) edge node[left] {\tiny 27} (2);
\draw (2) edge node[above] {\tiny 25} (3);
\draw (1) edge node[left] {\tiny 25} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 52} (1);
\draw (1) edge node[left] {\tiny 26} (2);
\draw (2) edge node[above] {\tiny 27} (3);
\draw (1) edge node[left] {\tiny 25} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 54} (1);
\draw (1) edge node[left] {\tiny 26} (2);
\draw (2) edge node[above] {\tiny 26} (3);
\draw (1) edge node[left] {\tiny 27} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 55} (1);
\draw (1) edge node[left] {\tiny 28} (2);
\draw (2) edge node[above] {\tiny 26} (3);
\draw (1) edge node[left] {\tiny 26} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 54} (1);
\draw (1) edge node[left] {\tiny 27} (2);
\draw (2) edge node[above] {\tiny 28} (3);
\draw (1) edge node[left] {\tiny 26} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 56} (1);
\draw (1) edge node[left] {\tiny 27} (2);
\draw (2) edge node[above] {\tiny 27} (3);
\draw (1) edge node[left] {\tiny 28} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 57} (1);
\draw (1) edge node[left] {\tiny 29} (2);
\draw (2) edge node[above] {\tiny 27} (3);
\draw (1) edge node[left] {\tiny 27} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 56} (1);
\draw (1) edge node[left] {\tiny 28} (2);
\draw (2) edge node[above] {\tiny 29} (3);
\draw (1) edge node[left] {\tiny 27} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 58} (1);
\draw (1) edge node[left] {\tiny 28} (2);
\draw (2) edge node[above] {\tiny 28} (3);
\draw (1) edge node[left] {\tiny 29} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 59} (1);
\draw (1) edge node[left] {\tiny 30} (2);
\draw (2) edge node[above] {\tiny 28} (3);
\draw (1) edge node[left] {\tiny 28} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 58} (1);
\draw (1) edge node[left] {\tiny 29} (2);
\draw (2) edge node[above] {\tiny 30} (3);
\draw (1) edge node[left] {\tiny 28} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 60} (1);
\draw (1) edge node[left] {\tiny 29} (2);
\draw (2) edge node[above] {\tiny 29} (3);
\draw (1) edge node[left] {\tiny 30} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 61} (1);
\draw (1) edge node[left] {\tiny 31} (2);
\draw (2) edge node[above] {\tiny 29} (3);
\draw (1) edge node[left] {\tiny 29} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 60} (1);
\draw (1) edge node[left] {\tiny 30} (2);
\draw (2) edge node[above] {\tiny 31} (3);
\draw (1) edge node[left] {\tiny 29} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 62} (1);
\draw (1) edge node[left] {\tiny 30} (2);
\draw (2) edge node[above] {\tiny 30} (3);
\draw (1) edge node[left] {\tiny 31} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 63} (1);
\draw (1) edge node[left] {\tiny 32} (2);
\draw (2) edge node[above] {\tiny 30} (3);
\draw (1) edge node[left] {\tiny 30} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 62} (1);
\draw (1) edge node[left] {\tiny 31} (2);
\draw (2) edge node[above] {\tiny 32} (3);
\draw (1) edge node[left] {\tiny 30} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 64} (1);
\draw (1) edge node[left] {\tiny 31} (2);
\draw (2) edge node[above] {\tiny 31} (3);
\draw (1) edge node[left] {\tiny 32} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 65} (1);
\draw (1) edge node[left] {\tiny 33} (2);
\draw (2) edge node[above] {\tiny 31} (3);
\draw (1) edge node[left] {\tiny 31} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 64} (1);
\draw (1) edge node[left] {\tiny 32} (2);
\draw (2) edge node[above] {\tiny 33} (3);
\draw (1) edge node[left] {\tiny 31} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 66} (1);
\draw (1) edge node[left] {\tiny 32} (2);
\draw (2) edge node[above] {\tiny 32} (3);
\draw (1) edge node[left] {\tiny 33} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
\draw (0,1) node [circle, draw] (2) {};
...
\draw (4) edge node[below] {\tiny 67} (1);
\draw (1) edge node[left] {\tiny 34} (2);
\draw (2) edge node[above] {\tiny 32} (3);
\draw (1) edge node[left] {\tiny 32} (3);
\end{tikzpicture}
\begin{tikzpicture}
...
\draw (4) edge node[below] {\tiny 66} (1);
\draw (1) edge node[left] {\tiny 33} (2);
\draw (2) edge node[above] {\tiny 34} (3);
\draw (1) edge node[left] {\tiny 32} (3);
\end{tikzpicture}
\begin{tikzpicture}
\draw (0,0) node [circle, draw] (1) {};
...
\draw (4) edge node[below] {\tiny 68} (1);
\draw (1) edge node[left] {\tiny 33} (2);
\draw (2) edge node[above] {\tiny 33} (3);
\draw (1) edge node[left] {\tiny 34} (3);
\end{tikzpicture}
#+end_export
