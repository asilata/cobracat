...
* The graph  
  #+begin_src dot :file ttauta3.svg :exports results :cmd neato
	...
	graph[overlap=false];
	# Vertices
	"abcx" [image="abcx.png", label=""];
	"abcy" [image="abcy.png", label=""];
	"acdy" [image="acdy.png", label=""];
	"acdx" [image="acdx.png", label=""];
	"abdy" [image="abdy.png", label=""];
	"abdx" [image="abdx.png", label=""];
	"bcdy" [image="bcdy.png", label=""];
	"bcdx" [image="bcdx.png", label=""];
